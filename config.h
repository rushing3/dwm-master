...
static const char *vol_up[]  = { "amixer", "-q", "-D", "pulse", "sset", "Master", "2%+", NULL };
static const char *vol_dwn[] = { "amixer", "-q", "-D", "pulse", "sset", "Master", "2%-", NULL };
...
static const char *lock_cmd[]   = { "i3modlock.sh", NULL };
...
static Key keys[] = {
  ...
  { MODKEY,                   XK_Left, spawn,          { .v = vol_dwn } },
  { MODKEY,                   XK_Right, spawn,          { .v = vol_up  } },
  ...
  { ControlMask|MODKEY,  XK_l,                spawn,          { .v = lock_cmd } },
